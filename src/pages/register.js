...
export default function Register() {
  ...
  return (
    <Layout title="Register | Bawar Biryani">
      <div className="min-h-[70vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
            ...
            <div className="rounded-md shadow-sm -space-y-px">
              ...
              <div>
                <input
                  type="email"
                  required
                  className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-maroon focus:border-maroon focus:z-10 sm:text-sm"
          ...
          <div className="text-center">
            <Link href="/login" className="text-sm text-maroon hover:text-maroon-dark">
